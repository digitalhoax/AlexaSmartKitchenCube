...
public class Device {
    ...
    public static Device getDevice(String deviceId, String accessToken) throws Exception {
        URL url = new URL("https://api.particle.io/v1/devices/" + deviceId + "?access_token=" + accessToken);
    ...
    public static ArrayList<Device> getDevices(String accessToken) throws Exception {
        URL url = new URL("https://api.particle.io/v1/devices?access_token="+accessToken);
        URLConnection conn = url.openConnection();
        conn.connect();
    ...
    public Integer callFunction(String functionName, String arg, String accessToken) throws Exception {
    	URL url = new URL("https://api.particle.io/v1/devices/" + id + "/" + functionName + "?access_token=" + accessToken + "");
     ...
     * @throws Exception On more serious failures.
     */
    public static Integer callFunction(String functionName, String arg, String id , String accessToken) throws Exception {
    		URL url = new URL("https://api.particle.io/v1/devices/" + id + "/" + functionName + "?access_token=" + accessToken + "");
        HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        conn.setDoOutput(true);
    ...
    public Object readAny(String name, String accessToken) throws Exception {
        URL url = new URL("https://api.particle.io/v1/devices/" + id + "/" + name + "?access_token=" + accessToken);
        HttpsURLConnection conn = (HttpsURLConnection) url.openConnection();
